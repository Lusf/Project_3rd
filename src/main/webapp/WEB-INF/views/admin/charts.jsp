...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <!-- Custom CSS -->
    <link href="<c:url value= '/resources/assets/admin/css/sb-admin.css'/>" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="<c:url value= '/resources/assets/admin/css/plugins/morris.css'/>"  rel="stylesheet">
