			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<!-- 검색 옵션 -->
						<form
							action="${pageContext.request.contextPath }/travelge/travelgeInfoUpdate"
							...
							<div class="row">
								<div class="form-group col-xs-3">
									<label for="travelgeName">travelgeName</label> <input
										...
										id="travelgeName" placeholder="travelgeName" value="${list[0].travelgeName}">
								</div>

								<div class="form-group col-xs-6">
									<label for="travelgeAddr">travelgeAddr</label> <input
										type="text" class="form-control" name="travelgeAddr"
										id="travelgeAddr" placeholder="travelgeAddr" value="${list[0].travelgeAddr}">
								</div>
							...
							<div class="form-group">
								...
								<textarea class="form-control" rows="3" name="travelgeDescription" >${list[0].travelgeDescription}</textarea>
							</div>
							<div class="row">
								<div class="filebox">
									...
									<div class="form-groupcol-xs-6">
										<input class="upload-name" value="${list[0].travelgePhotos}" disabled="disabled" >
										<label for="upload">사진 업로드</label> 
										<input type="file" id="upload" class="upload-hidden" name="file" value="${list[0].travelgePhotos}">
										<input type="hidden" name="travelgePhotos" value="${list[0].travelgePhotos}">
									</div>
								</div>
							</div>
							<div class="row">
								<div class="form-group col-xs-6">
									<label for="travelgeDescription">travelgeCoordinates</label> <input
										...
										class="form-control" value="${list[0].travelgeCoordinates}">
