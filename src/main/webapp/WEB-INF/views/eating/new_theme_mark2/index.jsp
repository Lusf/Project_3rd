         ...
         <nav class="navbar navbar-default">
            ...
            <div class="collapse navbar-collapse js-navbar-collapse row">
               <ul class="nav navbar-nav">
                  ...
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown">쓸까말까<span
                        ...
                        <li class="col-sm-3 col-xs-6 smartphone-fw">
                           <ul>
                              <li class="dropdown-header">
                              	<a href="${pageContext.request.contextPath}/user/mypage">My Page</a></li>
                              <li class="dropdown-header">
         ...
         <div class="modal-content shadow">
            ...
            <div class="modal-body">
               <div class="post-entry post-entry-modal">
                  ...
                  <img alt="user avatar" class="post-entry-author pull-left" 
				...
				<div class="collapse navbar-collapse js-navbar-collapse row">
					...
					<div class="row">
								<div class="form-group col-xs-6">
									...
									<input type="text" id="restaurantCoordinates" placeholder="주소검색 후 상세입력해 주세요" name="restaurantCoordinates"
										class="form-control">
				...
				<div class="modal-body">
					<div class="post-entry post-entry-modal">
						...
						<form action="eating/insert">
							<div>
								<label for="restaurantAddr">지역별</label> <select
									class="form-control">
									<option disabled="disabled">지역을 고르세요</option>
									<option value="SU">서울</option>
									<option value="DJ">대전</option>
							...
							<div>
								<label for="category">음식별</label> <select class="form-control">
									<option disabled="disabled">음식종류를 고르세요</option>
									<option value="KR">한식</option>
									<option value="CN">중식</option>
									<option value="EN">양식</option>
							...
							<div class="form-group">
								...
								<textarea class="form-control" rows="5" id="restaurantInfo"
									placeholder="정보를 입력하세요"></textarea>
								<!-- <input type="text" class="form-control" id="restaurantInfo" placeholder="정보를 입력하세요"> -->
							</div>
...
>>>>>>> f8ffb4c9319052bccb3e477c9326efa73c0d2510
</script>
</html>