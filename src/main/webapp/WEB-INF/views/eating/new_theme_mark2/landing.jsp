...
<html lang="zxx">
	...
	<section class="developer-landing-header" style="background-image: url(assets/img/developer/platinum.jpg);">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
		...
		<div class=" developer-landing-row-background mt-60 pt-60 pb-60">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="row">
						<div class="col-md-6">
						 	<img alt="image description" class="img-responsive mt-30" src="assets/img/developer/platinum.jpg">
						</div>
						<div class="col-md-6">
