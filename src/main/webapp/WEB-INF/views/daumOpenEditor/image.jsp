...
<script type=text/javascript
	src="${pageContext.request.contextPath}/resources/assets/daumOpenEditor/js/jquery.form.js"></script>

<!-- 다음오픈에디터 라이브러리 -->
<link rel=stylesheet type=text/css
	href="${pageContext.request.contextPath}/resources/assets/daumOpenEditor/css/popup.css"
	charset=utf-8 />
<script type=text/javascript charset=utf-8
	src="${pageContext.request.contextPath}/resources/assets/daumOpenEditor/js/popup.js"></script>
...
<script>
	...
	$(document).ready(function(){
		...
		$('.submit a').on('click', function () 
			...
			var fileName = $('#text111').val(); // 파일명(절대경로명 또는 단일명) 
...
<body onload="initUploader();">
	...
	<div class="wrapper">
			...
			<dl class=alert>
				...
				<dd>
					<form id=daumOpenEditorForm encType=multipart/form-data method=post
						...
						<!-- 파일첨부 -->
						<div class=file>
							<input disabled class=file-text id="text111"> <label
								class=file-btn for=uploadInputBox>사진첨부</label> <input
								id=uploadInputBox style="display: none" type=file name=Filedata>
							<!-- 버튼대체용(안보임) -->
						</div>
						<!-- //파일첨부 -->
					</form>
		...
		<div class="footer">
			...
			<ul>
				<li class="submit"><a href="#" onclick="done();" title="등록"
