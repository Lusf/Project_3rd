...
insert into Look_Info values ('B01', 'lim2', '원더우먼', '주디가 좋아1', '감독누구1', '원더우먼.jpg', '애니매이션1', '2017/06/11', '2017/06/13', '판교', 'movie','15세' );
insert into Look_Info values ('B02', 'lim2', '미이라', '주디가 좋아2', '감독누구2', '미이라.jpg', '애니매이션2', '2017/06/11', '2017/06/13', '판교', 'movie','15세' );
...
insert into Look_Info values ('B05', 'lim2', '악녀', '주디가 좋아5', '감독누구5', '악녀.jpg', '애니매이션5', '2017/06/11', '2017/06/13', '판교', 'movie','청불' );


insert into Look_Info values ('B06', 'lim2', '보이스', '주디가 좋아1', '감독누구1', '보이스.jpg', '애니매이션1', '2017/06/11', '2017/06/13', '판교', 'tv','청불' );
insert into Look_Info values ('B07', 'lim2', '터널', '주디가 좋아2', '감독누구2', '터널.jpg', '애니매이션2', '2017/06/11', '2017/06/13', '판교', 'tv','15세' );
